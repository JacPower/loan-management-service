...
public class Constants {
    ...
    public static final String KYC_REQUEST_TEMPLATE = """
            ...
            """;
    public static final String TRANSACTIONS_REQUEST_TEMPLATE = """
            ...
            """;
    public static final String MOCK_TRANSACTIONS_RESPONSE = """
                [
                {
    ...
    private Constants() {
        throw new IllegalStateException("Constants class instantiation not allowed.");
    }
}
